...
import { FaLongArrowAltRight, FaLongArrowAltLeft, FaCcPaypal, FaInstagram, FaTiktok, FaPinterest } from "react-icons/fa";
                ...
                <div className="row align-items-center mb-4">
                    ...
                    >
                        ...
                        >
                            ...
                            <li className="link-item fw-bold mb-3">
                                <FaPinterest className={`${i18n.language !== "ar" ? "me-2" : "ms-2"}`} />
                                <Link href={process.env.PINTEREST_LINK} target="_blank" className="text-dark link-btn">{t("Pinterest").toUpperCase()}</Link>
                            </li>
                            <li className="link-item fw-bold mb-3">
